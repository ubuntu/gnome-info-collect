...
*[![gnome-info-collect](https://snapcraft.io/gnome-info-collect/badge.svg)](https://snapcraft.io/gnome-info-collect)
[![gnome-info-collect](https://snapcraft.io/gnome-info-collect/trending.svg?name=0)](https://snapcraft.io/gnome-info-collect)*
...
git remote add ubuntu https://github.com/ubuntu/gnome-info-collect.git
git fetch --all
```
